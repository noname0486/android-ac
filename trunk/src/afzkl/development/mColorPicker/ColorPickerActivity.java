 ...
 * 
 * Integrated to android-ac by Dieter Roth 2011-06-16
 *  - Expand prefKey and title to intent parameters
 */
...
public class ColorPickerActivity extends Activity implements
	...
	public final static String INTENT_PREF_KEY = "prefKey";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (b != null) {
			initialColor = b.getInt(INTENT_DATA_INITIAL_COLOR);
			 mPrefKey = b.getString(INTENT_PREF_KEY);
			 mTitle = b.getString(INTENT_TITLE);
		}
	...
	public void onClick(View v) {
		...
		case R.id.ok_button:
			...
			i.putExtra(INTENT_PREF_KEY, mPrefKey);
			i.putExtra(INTENT_TITLE, mTitle);
